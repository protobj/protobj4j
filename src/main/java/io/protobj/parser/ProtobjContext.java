    ...
    public Map<String, MessageConfig> load(List<File> fileList) throws Exception {
        ...
        for (File file : fileList) {
            CompletableFuture.runAsync(() -> {
                ...
                ProtobjParser parser = new ProtobjParser(file.getAbsolutePath(), commonTokenStream);
                ...
                ParseTreeWalker.DEFAULT.walk(parser, protobjParser.protobj());
                Map<String, MessageConfig> configMap = parser.getMessageConfigMap();
