...
public class ProtobjFileReader extends ProtobjBaseListener {
    ...
    public ProtobjFileReader(String fileName, CommonTokenStream commonTokenStream) {
    ...
    private String getLeftDesc(Token token) {
        ...
        List<Token> hiddenTokensToLeft = commonTokenStream.getHiddenTokensToLeft(tokenIndex, 1);
        String desc = null;
    ...
    private String getRightDesc(Token token) {
        int tokenIndex = token.getTokenIndex();
        List<Token> hiddenTokensToRight = commonTokenStream.getHiddenTokensToRight(tokenIndex, 1);
        String desc = null;
