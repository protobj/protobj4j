...
public class TestMsgSchema implements Schema {

    @Override
    public void writeTo(Output output, Object message, boolean polymorphic) throws IOException {
        writeTo(output, (TestMsg) message, polymorphic);
    }

    public static void writeTo(Output output, TestMsg message, boolean polymorphic) throws IOException {
        if (polymorphic) {
        ...
        // TestMsg0 a16 = 12 ; 
        if (message.getA16() != null) {
            output.writeMessage(12, () -> TestMsg0Schema.writeTo(output, message.getA16(), false));
        }
    ...
    public Object mergeFrom(Input input, Object message) throws IOException {
        return mergeFrom(input, (TestMsg) message);
    }

    public static TestMsg mergeFrom(Input input, TestMsg msg) throws IOException {
        ...
        do {
            switch (fieldNumber) {
                ...
                case 12: {
                    ...
                    message.setA16(TestMsg0Schema.mergeFrom(input,null));
